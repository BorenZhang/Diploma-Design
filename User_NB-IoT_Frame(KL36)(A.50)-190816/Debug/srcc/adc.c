...
//内部函数声明
void adc_cal(void);
void adc_init_inner( uint_8 chnGroup,uint_8 diff,uint_8 accurary,uint_8 HDAve);
uint_16 adc_read_inner(uint_8 channel);
...
//============================================================================
void adc_init(uint_16 A_SENSOR_No,uint_8 accurary)
{
	uint_8 chnGroup,diff,acc;
	chnGroup = (uint_8)(A_SENSOR_No>>8);
	diff = 0;
	acc = accurary;
...
//参数说明：A_SENSOR_No：可用模拟量传感器通道，可用参数可参见gec.h文件
//============================================================================
uint_16 adc_read(uint_16 A_SENSOR_No)
{
	uint_8 channel;
	channel = (uint_8)A_SENSOR_No;
